...
public class Main {
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("8. Agregar nuevo producto");
        System.out.println("9. Eliminar producto");// Nueva opción
    ...
    private static void eliminarProducto() {
        ...
        System.out.print("¿Está seguro que desea eliminar este producto? (si/no): ");
    ...
    // NUEVO: Método para agregar un nuevo producto
    private static void agregarNuevoProducto() {
        ...
        int id = inventarioService.obtenerTodosLosProductos().size() + 1;

        Producto nuevoProducto = new Producto(id, nombre, precio, stock);
        boolean agregado = inventarioService.agregarNuevoProducto(nuevoProducto);

        if (agregado) {
            System.out.println("Producto agregado correctamente.");
        } else {
            System.out.println("No se pudo agregar el producto. Nombre duplicado.");
        }
    }
}